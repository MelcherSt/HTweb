<li class="dropdown">
	...
	<ul class="dropdown-menu notification-menu">
		...
		<li><a href="<?= Uri::create($notification->href) ?>"><span class="<?= $notification->icon ?> pull-right"></span> <h6><?= $notification->title ?> <small><?= Utils::format_date($notification->created, 'D H:i')?></small></h6> <p><?= $notification->text ?></p></a></li>
		<?php endforeach; ?>
